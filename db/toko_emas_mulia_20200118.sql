...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2020 at 02:15 AM
...
('AD030', 'A', 'D', 'DISNEY MICKEY harusnya gi', 0, 2, 2.58, 4),
...
('BG001', 'B', 'G', 'BOLA FULL AD* harusnya AG', 0, 3, 1.36, 4),
...
('CV366', 'C', 'V', 'PER PITA FULL AD 1BOLA', 0, 3, 0.87, 2),
...
('CV385', 'C', 'V', 'KUPU 1 AD', 0, 2, 0.87, 2),
...
('CV407', 'C', 'V', 'VAR PTH HATI AD', 0, 3, 1.23, 2),
...
('CV414', 'C', 'V', 'BLT LBG AD', 0, 3, 1.15, 2),
...
('CV455', 'C', 'V', 'CARTIER CAT AD* S', 0, 2, 2.17, 4),
...
('CV463', 'C', 'V', '1AD PINK+AD KECIL PTH', 0, 3, 1.77, 2),
...
('CV471', 'C', 'V', 'KUPU AD', 0, 2, 1.72, 2),
('CV472', 'C', 'V', 'S 2AD', 0, 2, 1.07, 2),
('CV473', 'C', 'V', 'VAR PTH 3HATI', 0, 2, 1.05, 2),
...
('GB014', 'G', 'B', 'VAR BTG *RETURN', 0, 2, 5.08, 4),
('GB015', 'G', 'B', 'VAR BUNGA *RETURN', 0, 2, 10.06, 4),
('GB016', 'G', 'B', 'C VAR PTH MRH *RETURN', 0, 2, 7.1, 4),
('GB017', 'G', 'B', 'C VAR PTH MRH *RETURN', 0, 2, 8, 4),
...
('GB054', 'G', 'B', 'BLT RANTAI VAR PTH *RETUR', 0, 2, 9.31, 4),
...
('GB070', 'G', 'B', 'OVAL 3 BUNGA TIMBUL *RETU', 0, 3, 7.05, 4),
...
('GB129', 'G', 'B', 'CARTIER AD *RUSAK', 0, 3, 5.25, 4),
...
('IB016', 'I', 'B', 'VAR PTH+AD PTH PINK *RUSA', 3, 2, 2.04, 4),
...
('IB055', 'I', 'B', 'CAT BNK BINTANG AD * DOUB', 3, 2, 2.1, 4),
...
('KN018', 'K', 'N', 'FNC ALFABET J RETUR', 1, 2, 6.53, 4),
...
('TD099', 'T', 'D', 'HATI AD *RETURN', 0, 2, 1.04, 4),
...
('TD252', 'T', 'D', 'BOLA FULL AD PTH+HITAM TN', 3, 3, 0.86, 2),
