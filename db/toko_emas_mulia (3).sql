...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2020 at 09:12 AM
...
('AM006', 'A', 'M', 'BOLA MOZAIK', 0, 2, 0.75, 2),
...
('AM108', 'A', 'M', 'BTG FULL AD PINK*', 3, 2, 0.79, 2),
...
('CV467', 'C', 'V', 'T SALIPAN CAT', 0, 3, 1.86, 2),
...
('CV492', 'C', 'V', 'FULL AD', 0, 2, 3.24, 2),
('CV493', 'C', 'V', '1AD BESAR + KCL', 0, 2, 2.15, 2),
...
('CV498', 'C', 'V', 'VAR PTH AD*', 0, 3, 1, 2),
('CV499', 'C', 'V', 'FROZEN AD BIRU PTH', 0, 2, 0.95, 2),
...
('CV508', 'C', 'V', 'PITA TALI', 0, 2, 0.84, 2),
('CV509', 'C', 'V', 'KUNCI AD SALIPAN', 0, 2, 1.16, 2),
('CV510', 'C', 'V', '2HATI AD PISAH', 0, 3, 1.04, 2),
...
('CV520', 'C', 'V', 'GLMBNG AD VAR PTH', 0, 3, 1.68, 2),
...
('CV525', 'C', 'V', 'VAR PTH+AD', 0, 3, 1.18, 2),
('CV526', 'C', 'V', 'RANTE AD*', 0, 3, 1.35, 2),
('CV527', 'C', 'V', 'PER PITA AD SALIPAN*', 8, 3, 0.88, 2),
('CV528', 'C', 'V', 'PER BLT AD SALIPAN*', 8, 3, 0.78, 2),
('CV529', 'C', 'V', 'VAR PTH HATI AD*', 0, 3, 1.22, 2);
INSERT INTO `master_items` (`id`, `category`, `subcategory`, `nama`, `supplier`, `karat`, `berat`, `stocks`) VALUES
...
('CV534', 'C', 'V', 'PER BLT AD SALIPAN', 8, 3, 0.82, 2),
...
('DV120', 'D', 'V', 'BUNGA PUTIK AD', 0, 3, 0.74, 2),
('DV121', 'D', 'V', 'BUNGA PUTIK AD', 0, 3, 0.73, 2),
...
('GB196', 'G', 'B', 'OVAL HATI LBG AD', 0, 2, 3.93, 2),
...
('GB209', 'G', 'B', 'CARTIER*', 0, 2, 4.95, 2),
('GB210', 'G', 'B', '3 KUPU STGH AD*', 0, 2, 3.03, 2),
('GB211', 'G', 'B', 'OVAL BNGA AD *', 0, 3, 6.26, 2),
('GB212', 'G', 'B', 'OVAL STGH PIPA FULL AD', 0, 3, 5.17, 2),
('GB213', 'G', 'B', 'OVAL PAKU TUSUK AD*', 0, 2, 6.3, 2),
('GB214', 'G', 'B', 'OVAL PAKU TUSUK AD*', 0, 2, 6.48, 2),
...
('GB219', 'G', 'B', 'OVAL CARTIER*', 0, 2, 4.88, 2),
('GB220', 'G', 'B', 'CARTIER AD', 0, 2, 7.23, 2),
('GB221', 'G', 'B', 'BUNGA BLT FULL AD', 0, 2, 4.96, 2),
...
('GB228', 'G', 'B', 'OVAL ROMAWI PAKU', 0, 2, 5.33, 2),
...
('GC026', 'G', 'C', 'VAR PTH RANTE*', 8, 3, 2.96, 2),
('GC027', 'G', 'C', 'VAR PTH RANTE*', 8, 3, 3, 2),
...
('GM083', 'G', 'M', 'R*', 0, 2, 1.85, 2),
('GM084', 'G', 'M', 'KOIN 3WNA', 0, 2, 3.92, 3),
('GM085', 'G', 'M', 'FNC 11MN', 0, 2, 6.98, 2),
('GM086', 'G', 'M', 'FNC 5MN KOKOT PER', 0, 2, 3.2, 2),
('GM087', 'G', 'M', 'RANTE 5MN', 0, 2, 5.1, 2),
('GM088', 'G', 'M', 'FNC 8MN', 0, 2, 5.12, 2),
('GM089', 'G', 'M', 'PLAKATO OVAL PERSEGI', 0, 3, 3.56, 2),
('GM090', 'G', 'M', 'FNC 4MN 2HTI 2BTG*', 0, 3, 2.68, 2),
('GM091', 'G', 'M', 'FNC 4MN 2BLT 2TETES', 0, 3, 3.05, 2),
('GM092', 'G', 'M', 'DOUBLE PERSEGI GANDENG*', 0, 2, 8.43, 2),
...
('HM029', 'H', 'M', 'FNC 6MN HK CAT', 0, 2, 2.36, 2),
...
('HP006', 'H', 'P', 'HLW PATAH*', 3, 2, 2.04, 2),
...
('KC003', 'K', 'C', 'KECIL', 0, 1, 3.95, 2),
('KC004', 'K', 'C', 'KECIL', 0, 1, 4.06, 2),
...
('KS095', 'K', 'S', '*', 0, 1, 2.04, 2),
('KS096', 'K', 'S', '', 0, 1, 2.95, 2),
('LL001', 'L', 'L', '', 0, 2, 7.1, 2),
('LL002', 'L', 'L', '', 0, 2, 5, 3),
...
('NN020', 'N', 'N', 'ALFABET M*', 1, 1, 2.01, 2),
...
('TA020', 'T', 'A', 'OWL*', 1, 2, 0.52, 2),
('TA021', 'T', 'A', 'KUDA PONI UNGU', 3, 3, 0.45, 1),
('TA022', 'T', 'A', 'KUDA PONI UNGU', 3, 3, 0.45, 2),
...
('TD256', 'T', 'D', 'BOLA FULL AD TANPA SERIPE', 3, 3, 1.46, 2),
...
('TD264', 'T', 'D', 'BOLA LBG AD TNPASERIPERI*', 3, 3, 0.94, 2),
...
('TD268', 'T', 'D', 'BLG LBG AD*', 3, 3, 0.87, 2),
...
('TD276', 'T', 'D', 'BOLA MOZAIK*', 0, 2, 0.72, 2),
('TD277', 'T', 'D', 'VAR PTH AD*', 0, 2, 1.16, 2),
('TD278', 'T', 'D', 'BUNGA AD*', 3, 3, 0.58, 2),
('TD279', 'T', 'D', 'BOLA FULL AD TANPA SERIPE', 3, 3, 0.82, 2),
