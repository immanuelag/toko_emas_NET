...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2020 at 11:15 AM
...
('CV619', 'C', 'V', 'VAR PTH BNGA AD *CV596', 0, 2, 1, 2),
('CV620', 'C', 'V', 'S 1AD*', 8, 3, 1.02, 2),
('CV621', 'C', 'V', 'PER PITA AD SALIPAN*', 0, 3, 0.95, 2),
...
('GB244', 'G', 'B', 'OVAL CARTIER 1AD BESAR + ', 0, 2, 7.23, 2),
('GB245', 'G', 'B', 'OVAL 7BOLA 3WNA*', 0, 2, 5.04, 2),
...
('GM094', 'G', 'M', 'ALFABER R*', 0, 2, 1.85, 2),
...
('GP102', 'G', 'P', 'FNC PLAKATO 4MN*', 0, 3, 2.7, 2),
...
('TD301', 'T', 'D', '1AD HIJAU + AD KECIL PTH', 3, 3, 0.82, 2),
