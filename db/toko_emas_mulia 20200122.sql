...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2020 at 01:51 AM
...
('AM039', 'A', 'M', 'PJG HATI LBG + 2HT', 0, 2, 1.5, 2),
...
('CL061', 'C', 'L', 'VAR PTH 1AD*', 0, 3, 1.57, 2),
...
('CV423', 'C', 'V', 'VAR PTH AD', 0, 3, 1.13, 2),
...
('CV461', 'C', 'V', '3WAJIK AD PINK MERAH', 0, 3, 0.84, 2),
...
('CV476', 'C', 'V', 'KG WAJIK LBG*', 0, 2, 0.88, 2),
...
('CV490', 'C', 'V', '2BLT AD PTH+HTM TUMPUK', 0, 2, 1.33, 2),
...
('GB096', 'G', 'B', 'OVAL RANTAI VAR AD', 0, 2, 5.42, 1),
...
('GB212', 'G', 'B', 'OVAL STGH PIPA FULL AD*', 0, 3, 5.57, 2),
...
('TA018', 'T', 'A', 'PONI UNGU', 3, 3, 0.43, 2),
